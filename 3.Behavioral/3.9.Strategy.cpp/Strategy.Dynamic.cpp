...
namespace Dynamic
{
	...
	{
	public:
		void use(void) override { std::cout << "Strategy_1" << std::endl; };
	};

	class Strategy_2 : public Strategy
	{
	public:
		void use(void) override { std::cout << "Strategy_2" << std::endl; };
	};

	class Strategy_3 : public Strategy
	{
	public:
		void use(void) override { std::cout << "Strategy_3" << std::endl; };
	};
	...
	{
		std::cout << "--------------------------" << std::endl;
		std::cout << "Executing dynamic example:" << std::endl;
		Client customClient;
		Strategy_1 str1;
		Strategy_2 str2;
		Strategy_3 str3;
